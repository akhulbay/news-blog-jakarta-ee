...
<div class="container" style="min-height: 80vh;">
    <div class="row mt-3">
        <div class="col-sm-8 mx-auto">
            <%
                BlockedUser blockedUser = (BlockedUser) request.getAttribute("blockeduser");
                if (blockedUser != null) {
            %>
            <div class="p-5 mb-3" style="background-color: #9090d0; border-radius: 5px">
                <table>
                    <tr>
                        <th scope="row">ID:</th>
                        <td><%=blockedUser.getUser().getId()%></td>
                    </tr>
                    <tr>
                        <th scope="row">Full Name:</th>
                        <td><%=blockedUser.getUser().getFullName()%></td>
                    </tr>
                    <tr>
                        <th scope="row">Email:</th>
                        <td><%=blockedUser.getUser().getEmail()%></td>
                    </tr>
                    <tr>
                        <th scope="row">Password:</th>
                        <td><%=blockedUser.getUser().getPassword()%></td>
                    </tr>
                    <tr>
                        <th scope="row">Birth Date:</th>
                        <td><%=blockedUser.getUser().getBirthDate()%></td>
                    </tr>
                    <tr>
                        <th scope="row">Role:</th>
                        <td><%=blockedUser.getUser().getRole() == 1 ? "ADMIN" : "CUSTOMER"%></td>
                    </tr>
                </table>
            </div>
            <div>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <form action="${pageContext.request.contextPath}/unblock-user" method="post">
                                <input type="hidden" value="<%=blockedUser.getId()%>" name="blocked-user-id">
